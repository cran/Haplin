...
#
#
##	.indices <- codes(factor(INDICES[.order]))	# SET VALUES 1,2,3,... FOR THE ORDERED LEVELS
#
###	.indices <- match(INDICES[.order], sort(unique.default(INDICES[.order]), na.last = T)) # ASSIGN UNIQUE INTEGER RANKS, AVOID codes SINCE THIS IS NOT PRESENT IN MOST RECENT R
