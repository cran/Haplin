...
#' @param file.out The base for the output filename (default: "my_data_onlyChildren").
...
getChildren <- function( data.in = stop( "No data given!", call. = FALSE ), file.out = "my_data_onlyChildren", dir.out = ".", overwrite = NULL ){
